...
namespace _5._1.methodCall
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // 5.3.8. Необходимо передать по ссылке размерность массива в метод GetArrayFromConsole и изменить её.
            ...
            if (needSort == "да")
            {            
                ShowArray(SortArray(GetArrayFromConsole(ref arraySize)), true);
            }
            else
            {
